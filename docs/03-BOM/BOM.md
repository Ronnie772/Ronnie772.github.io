...
## Overview
This BOM outlines every item needed to assemble the motor subsystem for the Garden Buddy, it serves as the main reference for the procurement of parts and cost estimation.
